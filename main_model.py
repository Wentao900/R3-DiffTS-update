...
class CSDI_Forecasting(CSDI_base):
    ...
    def _compute_text_benefit_gate(self, observed_data, cond_mask, text_pooled, text_mask, trend_align):
        ...
        benefit_input = torch.cat([numeric_summary, text_pooled, quality, align], dim=1)
