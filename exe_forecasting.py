...
config["model"]["timestamp_prior"] = bool(config["model"].get("timestamp_prior", False))
config["model"]["timestamp_prior_residual"] = bool(config["model"].get("timestamp_prior_residual", True))
config["model"]["timestamp_prior_fusion"] = bool(config["model"].get("timestamp_prior_fusion", True))
config["model"]["timestamp_prior_temperature"] = float(config["model"].get("timestamp_prior_temperature", 0.05))
config["model"]["timestamp_prior_trend_mix"] = float(config["model"].get("timestamp_prior_trend_mix", 0.15))
config["model"]["timestamp_prior_max_alpha"] = float(config["model"].get("timestamp_prior_max_alpha", 0.5))
config["model"]["source_specific_text_gain"] = bool(config["model"].get("source_specific_text_gain", False))
config["model"]["event_evidence_alignment"] = bool(config["model"].get("event_evidence_alignment", False))
