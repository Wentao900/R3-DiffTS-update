...
def data_provider(args, flag):
    ...
    if args.data == 'custom':
        ...
        extra_kwargs['rag_consistency'] = getattr(args, "rag_consistency", False)
        extra_kwargs['consistency_unknown_penalty'] = getattr(args, "consistency_unknown_penalty", 1.0)
        extra_kwargs['consistency_conflict_penalty'] = getattr(args, "consistency_conflict_penalty", 0.5)
